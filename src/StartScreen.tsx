...
const StartScreen = ({ goToPage }: StartScreenProps) => {
  return (
    <div className="w-full h-full overflow-y-auto">
      <section
        className="h-screen w-full flex flex-col justify-center items-center text-center px-6"
      ...
      <section className="my-40 mx-15 text-left">
        ...
        <p className="text-left">
          ...
          all around the world across roughly eight centuries of history. Built
          by two students who earned 5s on the AP Exam, this website is designed
          to help you understand and synthesize the content in a visual,
          intuitive, and interactive way. And yet - content alone isn't enough
          to prepare yourself for success in AP World History - the exam is
          built on themes and historical thinking skills. What helped us most
          wasn't understanding every fact, but understanding how societies
          compare, change, and influence one another - and this website was
          built with that in mind. Whether your goal is to deepen your
          understanding of world history or score 5 on the AP Exam, this study
          tool offers a simple and effective path to get there. Click{" "}
          <span
      ...
      <section className="my-40 mx-15 text-left">
        ...
        <div className="flex flex-col md:flex-row items-start">
          ...
          />
          <p className="sm:mt-5">
            Track historical events in chronological order with our interactive
            timeline. Read about the Collegeboard theme, causes, and effects to
            gain a richer understanding of each event. By following the sequence
            of developments, you can see how one moment leads to the next and
            strengthen your sense of historical cause and effect.
          </p>
        </div>
      </section>
      <section className="my-40 mx-15 text-left">
        ...
        <div className="flex flex-col md:flex-row items-start">
          ...
          <p className="sm:mt-5">
            ...
            challenges you to compare them. After you come up with similarities
            and differences, check your answer with each country's notes. It’s a
            simple way to practice comparison and reinforce thematic
            understanding.
          </p>
        </div>
      </section>
      ...
      <section className="my-1">
        <p className="text-xs">
          Notes were taken from The Earth and Its Peoples - AP Edition - 4th ED,
          World History: Modern (1200-Present) AP ED, and class materials.
